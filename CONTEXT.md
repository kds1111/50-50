...
**Bail** — a failed landing: a named trick unfinished at touchdown, or a fall from a grind. Wipes the pending bank entirely ([#8](https://github.com/kds1111/50-50/issues/8)), then a knockdown in place: the board keeps its momentum and slides, the rider is down and cannot steer, and the whole greybox **flashes** — a stand-in for the fall animation ([#25](https://github.com/kds1111/50-50/issues/25)). The flash is a picture of the state, not a rule: **what “down” protects you from is not yet decided**, and nothing today stops a downed player being hit by the ball, being stripped, or grabbing and punching. The respawn puts you back **where you lost it**: on clear ground at or beside the point the bail fired, never where the board slid to. A **safe point** is the fallback.
